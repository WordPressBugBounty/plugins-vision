									...
									<div class="vision-block" al-attr.class.vision-block-folded="appData.ui.generalTab.main">
										...
										<div class="vision-block-data">
											...
											<div class="vision-control">
												...
												<div class="vision-label"><?php esc_html_e('Main map image', 'vision'); ?></div>
							...
							<div class="vision-main-panel">
								<div class="vision-edit-layers">
									...
									<div class="vision-layers-toolbar-view">
										<i class="icon icon-zoom-in" al-on.click="appData.fn.canvasZoomIn(appData)" title="<?php esc_html_e('Zoom in', 'vision'); ?>"></i>
										<span class="vision-zoom-value">{{appData.fn.getCanvasZoomForLabel(appData)}}%</span>
										<i class="icon icon-zoom-out" al-on.click="appData.fn.canvasZoomOut(appData)" title="<?php esc_html_e('Zoom out', 'vision'); ?>"></i>
										<i class="icon icon-minimize" al-on.click="appData.fn.canvasZoomDefault(appData)" title="<?php esc_html_e('Zoom default', 'vision'); ?>"></i>
										<i class="icon icon-fullscreen" al-on.click="appData.fn.canvasZoomFit(appData)" title="<?php esc_html_e('Zoom fit', 'vision'); ?>"></i>
										<i class="icon icon-rotate-ccw" al-on.click="appData.fn.canvasMoveDefault(appData)" title="<?php esc_html_e('Move default', 'vision'); ?>"></i>
									</div>
							...
							<div class="vision-sidebar-panel" al-attr.class.vision-hidden="!appData.ui.sidebar" al-style.width="appData.ui.sidebarWidth">
								<div class="vision-sidebar-resizer" al-on.mousedown="appData.fn.onSidebarResizeStart(appData, $event)">
									<div class="vision-sidebar-hide" al-on.click="appData.fn.toggleSidebarPanel(appData)">
										<i class="icon icon-chevron-right" al-if="appData.ui.sidebar"></i>
										<i class="icon icon-chevron-left" al-if="!appData.ui.sidebar"></i>
									</div>
								</div>
								...
								<div class="vision-data vision-no-scroll" al-attr.class.vision-active="appData.ui.layersTabs.layers">
